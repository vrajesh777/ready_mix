...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff;font-size:10px; font-family:'Arial', sans-serif;text-align:center;">
		<tr><td style="line-height:63px"> <!-- <img src="<?php echo e(asset('/')); ?>images/logo1.png" alt="" width="250"> --> </td></tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff;font-size:12px; font-family:'Arial', sans-serif;border:none">
		...
		<tr>
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff;border-right:0px solid #fff;"><strong style="font-size:9px;">
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    <!-- </strong><?php echo e($arr_del_note['order_details']['order']['cust_details']['first_name'] ?? ''); ?> <?php echo e($arr_del_note['order_details']['order']['cust_details']['last_name'] ?? ''); ?></td> -->
				</strong>
				<!-- <?php echo e($arr_del_note['order_details']['order']['cust_details']['last_name'] ?? ''); ?> -->
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<?php echo e($contract['structure_element']??''); ?></strong></td> 
		</tr>
	...
	<table class="table" width="110%" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff;border:none;font-size:9px; font-family:'Arial', sans-serif;">
		...
		<tr>
			<td style="line-height:155px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($arr_del_note['order_details']['product_details']['name'] ?? ''); ?></td>
			<td style="line-height:130px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($arr_del_note['order_details']['product_details']['mix_code'] ?? ''); ?></td>
			<td style="line-height:130px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($slamp??''); ?></td>
			<td style="line-height:130px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($cement??''); ?></td>
			<td style="line-height:130px;border-left:0px solid #fff;">       </td>
			<!--<td style="line-height:25px;border-left:0px solid #fff;"><?php echo e($air_content??''); ?></td>-->
			<td style="line-height:130px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($cement_type??''); ?></td>
			<!--<td style="line-height:25px;border-left:0px solid #fff;"><?php echo e('YNB'); ?></td>-->
			<!--<td style="line-height:25px;border-left:0px solid #fff;border-right:0px solid #fff;"><?php echo e($contract['concrete_temp']??''); ?></td>-->
		</tr>
	...
	<table class="table" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff;border:none;font-size:10px; font-family:'Arial', sans-serif;">
		...
		<tr>
		    <td style="line-height:20px;border-left:0px solid #fff; font-size:12px;"><?php echo e($air_content??''); ?></td>
		    <td style="line-height:20px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($contract['concrete_temp']??''); ?></td>
			<td style="line-height:20px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;"><?php echo e($w_c_ratio??''); ?></td>
			<td style="line-height:20px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;</td>
			<td style="line-height:20px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($rp); ?>/<?php echo e($sp); ?></td>
			<td style="line-height:20px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($sp??''); ?></td>
	...
	<table class="table" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff;border:none;font-size:10px; font-family:'Arial', sans-serif;">
		...
		<tr>
			<td style="line-height:15px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;<?php echo e($arr_del_note['order_details']['quantity'] ?? ''); ?></td>
			<td style="line-height:15px;border-left:0px solid #fff; font-size:12px;"><?php echo e($arr_del_note['order_details']['quantity_delivered']??0); ?></td>
			<td style="line-height:15px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;<?php echo e($arr_del_note['quantity'] ?? ''); ?></td>
			<td style="line-height:15px;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;<?php echo e($arr_del_note['load_no'] ?? ''); ?></td>
			<td style="line-height:15px;border-left:0px solid #fff; font-size:12px; width:10%x;">&nbsp;<?php echo e($arr_del_note['vehicle']['name'] ?? ''); ?></td>
			<!--<td style="line-height:15px;border-left:0px solid #fff; font-size:12px; width:10%x;">&nbsp;<?php echo e($arr_del_note['vehicle']['plate_no'] ?? ''); ?></td>-->
			<td style="line-height:15px;border-left:0px solid #fff; font-size:12px; width:10%x;">&nbsp;&nbsp;&nbsp;<?php echo e($arr_del_note['vehicle']['plate_no'] ?? ''); ?>&nbsp;<?php echo e($arr_del_note['vehicle']['plate_letter'] ?? ''); ?> </td>
	...
	<table class="table" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff;border:none;font-size:10px; font-family:'Arial', sans-serif;">
		...
		<tr>
			<td style="line-height:115px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;<?php echo e($arr_del_note['pump']??''); ?></td>
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;</td>
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;<?php echo e(\Carbon\Carbon::now()->format('g:i a')); ?></td>
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;</td>
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;</td>
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff; font-size:12px;">&nbsp;&nbsp;</td>
			<!-- <td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff;border-right:0px solid #fff;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($arr_del_note['driver']['first_name'] ?? ''); ?> <?php echo e($arr_del_note['driver']['last_name'] ?? ''); ?></td> -->
			<td style="line-height:22px;border-bottom:0px solid #fff;border-left:0px solid #fff;border-right:0px solid #fff; font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($arr_del_note['driver']['last_name'] ?? ''); ?></td>
		</tr>
...
<?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/delivery/delivery_orders/delivery_note_pdf.blade.php ENDPATH**/ ?>