...
<body style="max-width: 700px;margin:auto">
    ...
    <table id="parts_table">
        ...
        <?php $__currentLoopData = $arr_parts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $item = $part['item'] ?? [];
        ...
        <tr>
            ...
            <td><?php echo e($item['commodity_code'] ?? ''); ?></td>
            <td><?php echo e($item['commodity_name'] ?? ''); ?></td>
            <td><?php echo e($part['quantity'] ?? 0); ?> (<?php echo e($unit_detail['unit_symbol'] ?? ''); ?>)</td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    </table>
...
</html><?php /**PATH D:\wamp64\www\readymix-new\resources\views/vechicle_maintance/repair/show.blade.php ENDPATH**/ ?>