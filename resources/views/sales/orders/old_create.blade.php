						...
						<div class="col-sm-6 border-right">
							<div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="position-relative p-0">
                                        <input class="form-control timepicker pr-5" name="delivery_time" id="delivery_time" data-rule-required="true" placeholder="hh:mm" data-date-format="hh:mm A" value="09:00 AM">
					...
					<div class="row">
						<div class="form-group col-sm-6">
							<label class="col-form-label">Client Note</label>
		                   	<textarea name="client_note" rows="3" cols="3" class="form-control" placeholder="Client Note" ></textarea>
						</div>
						<div class="form-group col-sm-6">
							<label class="col-form-label">Terms & Conditions</label>
		                   	<textarea name="terms_n_cond" rows="3" cols="3" class="form-control" placeholder="Terms & Conditions" ></textarea>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-sm-6">
						...
						<div class="form-group col-sm-6">
							<label class="col-form-label">Remark</label>
		                   	<textarea name="remark" rows="2" cols="2" class="form-control" placeholder="Remark" ></textarea>
						</div>
					</div>
