...
<div class="page-header pt-3 mb-0 ">
    ...
    <div class="col-md-12">
      ...
      <input type="hidden" name="delivery_id" id="delivery_id">
       <div class="col-sm-4">
         <button type="button" style="display: none" id="cylinder_print_btn" onclick="printInvoice()" class="border-0 btn btn-primary btn-gradient-primary btn-rounded">Print</button>
       </div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-family:'Arial', sans-serif;text-align:center;">
	...
	<tr><td style="line-height:35px;"><h2 style="text-align:center;margin:0">{{ trans('admin.cylinder_report_title') }}</h2></td></tr>
	<tr><td style="line-height:20px;">&nbsp;</td></tr>
</table>
...
<section class="invoice print_section" id="cylinder_receipt_section">
</section>
  ...
  $(document).ready(function(){
	...
	function getDeliveryNoSuggestion(term)
    {
      ...
      var report_type = "{{ $report_type }}";
         ...
         $.ajax({
          url:"{{ $module_url_path }}/get_delivery_no_suggestion",
          method:"GET",
    ...
    {
    	 $.ajax({
          url:"{{ $module_url_path }}/get_delivery_details",
          method:"GET",
          ...
          $.ajax({
                    ...
                    success: function(data){
                      if (data.html != '') {
                        ...
                        $('#cylinder_receipt_section').html(data.html);
