					...
					<div class="row">
						{{-- <div class="col-sm-4">
							<div class="form-group">
            					...
            					<input type="text" class="form-control" name="name" id="name" placeholder="Parts Name" data-rule-required="true" value="{{ $arr_data['name'] ?? '' }}">
						...
						<div class="col-sm-4">
							<div class="form-group">
            					...
            					<input type="text" class="form-control" name="part_no" id="part_no" placeholder="Part No" data-rule-required="true" value="{{ $arr_data['part_no'] ?? '' }}">
            					<label class="error" id="name_error"></label>
