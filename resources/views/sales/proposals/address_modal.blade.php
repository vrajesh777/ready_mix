    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-md-12">
                        <div id="billing_details">
                            <div class="form-group" app-field-wrapper="billing_street">
                            	...
                            	<textarea id="billing_street" name="billing_street" class="form-control" rows="4">{{ $clone['address']??'' }}</textarea>
                            </div>
                            <div class="form-group" app-field-wrapper="billing_city">
                            	<label for="billing_city" class="control-label">{{ trans('admin.city') }}</label>
                            	<input type="text" id="billing_city" name="billing_city" class="form-control" value="{{ $clone['city']??'' }}">
                            </div>
                            <div class="form-group" app-field-wrapper="billing_state">
                            	<label for="billing_state" class="control-label">{{ trans('admin.state') }}</label>
                            	<input type="text" id="billing_state" name="billing_state" class="form-control" value="{{ $clone['state']??'' }}">
                            </div>
                            <div class="form-group" app-field-wrapper="billing_zip">
                            	<label for="billing_zip" class="control-label">{{ trans('admin.zip_code') }}</label>
                            	<input type="text" id="billing_zip" name="billing_zip" class="form-control" value="{{ $clone['postal_code']??'' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="form-group no-mbot">
                            <div class="checkbox checkbox-primary checkbox-inline">
                                ...
                                <label for="include_shipping">{{ trans('admin.shipping') }} {{ trans('admin.address') }} </label>
                            </div>
                        </div>
                        <div id="shipping_details" style="display: none;">
                            <div class="form-group">
                                <div class="checkbox checkbox-primary checkbox-inline">
                                    ...
                                    <label for="show_shipping_on_estimate">{{ trans('admin.show_shipping') }}</label>
                                </div>
                            </div>
            ...
            <div class="modal-footer modal-not-full-width">
                <a href="javascript:void(0);" id="apply_address" class="btn btn-info save-shipping-billing waves-effect waves-effect waves-light waves-ripple">{{ trans('admin.apply') }}</a>
            </div>
        </div>
    </div>
</div>
