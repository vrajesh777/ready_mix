				...
				<div class="card-body">
					...
					<div class="row">
							...
							<div class="row">
								<div class="form-group col-sm-6">
		                            ...
		                            <select name="cust_id" class="select2" id="cust_id" data-rule-required="true">
										...
										<option value="<?php echo e($cust['id']??''); ?>" <?php echo e(($clone['cust_id']??'')==($cust['id']??'')?'selected':''); ?> ><?php echo e($cust['first_name'] ?? ''); ?> <?php echo e($cust['last_name'] ?? ''); ?></option>
								...
								<div class="form-group col-sm-12">
									<div class="row">
										<div class="col-md-12">
											...
											<?php echo $__env->make('sales.orders.address_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
										</div>

										<div class="col-md-6">
											<p class="bold"><?php echo e(trans('admin.bill_to')); ?></p>
											<address>
												<span class="billing_street"><?php echo e($clone['billing_street']??'--'); ?></span><br>
												<span class="billing_city"><?php echo e($clone['billing_city']??'--'); ?></span>,
												<span class="billing_state"><?php echo e($clone['billing_state']??'--'); ?></span>
												<br>
												<span class="billing_zip"><?php echo e($clone['billing_zip']??'--'); ?></span>
											</address>
										</div>
										<div class="col-md-6">
								...
								<div class="form-group col-sm-6" style="display: none;">
		                            ...
		                            <select class="select" name="status">
										...
										<option value="in-progress"><?php echo e(trans('admin.in_progress')); ?></option>
										<option value="testing"><?php echo e(trans('admin.testings')); ?></option>
										<option value="re-build"><?php echo e(trans('admin.re_Build')); ?></option>
										<option value="re-testing"><?php echo e(trans('admin.re_testing')); ?></option>
										<option value="granted" selected=""><?php echo e(trans('admin.granted')); ?></option>
									</select>
								</div>

								<div class="form-group col-sm-12" style="display: none;">
									<label class="col-form-label"> <?php echo e(trans('admin.allowd_payment_mode')); ?></label>
								...
								<div class="form-group col-sm-6">
									<label class="col-form-label"><?php echo e(trans('admin.admin_note')); ?></label>
		                           	<textarea name="admin_note" rows="2" cols="2" class="form-control" placeholder="Admin Note" ><?php echo e($clone['admin_note']??''); ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="row">
								<div class="form-group col-sm-6">
									<label class="col-form-label"><?php echo e(trans('admin.pump')); ?> <span class="text-danger">*</span></label>
		                            <select class="select2" name="pump" data-rule-required="true" id="pump">
		                            	...
		                            	<?php if(isset($arr_pump) && count($arr_pump)>0): ?>
		                            		<?php $__currentLoopData = $arr_pump; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pump): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($pump['id'] ?? ''); ?>" 
												data-operator-id="<?php echo e($pump['operator_id'] ?? ''); ?>"  
												data-helper-id="<?php echo e($pump['helper_id'] ?? ''); ?>" 
												data-driver-id="<?php echo e($pump['driver_id'] ?? ''); ?>"
												><?php echo e($pump['name'] ?? ''); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
									</select>
								</div>
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row clone_master" id="clone_master">
						<div class="form-group col-sm-6">
							<label class="col-form-label"><?php echo e(trans('admin.select_mix')); ?><span class="text-danger">*</span></label>
						...
						<div class="form-group col-sm-6">
							...
							<input type="number" name="unit_quantity[]" value="" class="form-control" min="1" id="unit_quantity" data-rule-required="true"  >
									            ...
									            <div class="input-group">
									               	...
									               	<div class="input-group-append">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item disc_type_opt" data-type="fixed" href="javascript:void(0);"><?php echo e(trans('admin.fixed_amount')); ?></a>
														</div>
													</div>
					...
					<div class="row">
						<div class="form-group col-sm-6">
							<label class="col-form-label"><?php echo e(trans('admin.client_note')); ?></label>
		                   	<textarea name="client_note" rows="3" cols="3" class="form-control" placeholder="<?php echo e(trans('admin.client_note')); ?>" ></textarea>
						</div>
						<div class="form-group col-sm-6">
							<label class="col-form-label"><?php echo e(trans('admin.terms_&_conditions')); ?></label>
		                   	<textarea name="terms_n_cond" rows="3" cols="3" class="form-control" placeholder="<?php echo e(trans('admin.terms_&_conditions')); ?>" ></textarea>
						</div>
					</div>
					<div class="row">
						<div class="form-group col-sm-6">
							<label class="col-form-label"><?php echo e(trans('admin.structure')); ?></label>
                            <input type="text" id="structure" name="structure" class="form-control">
                            <div class="error"><?php echo e($errors->first('structure')); ?></div>
						</div>
						<div class="form-group col-sm-6">
							<label class="col-form-label"><?php echo e(trans('admin.remark')); ?></label>
		                   	<textarea name="remark" rows="2" cols="2" class="form-control" placeholder="<?php echo e(trans('admin.remark')); ?>" ></textarea>
						</div>
					</div>

					<div class="text-center py-3 w-100">
	                	<button type="button" class="border-0 btn btn-primary btn-gradient-primary btn-rounded" id="checkBalance"><?php echo e(trans('admin.save')); ?></button>&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	var pump_wise_qty = "<?php echo e(trans('admin.pump_wise_qty')); ?>";
	...
	$(document).ready(function() {
		...
		var cant_add_more = "<?php echo e(trans('admin.cant_add_more')); ?>";
		var search_for_an_item = "<?php echo e(trans('admin.search_for_an_item')); ?>";
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/sales/orders/create.blade.php ENDPATH**/ ?>