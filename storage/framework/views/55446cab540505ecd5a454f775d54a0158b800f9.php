						...
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="form-group col-sm-3 related_wrapp">
		                            ...
		                            <select name="vendor_id" class="form-control" id="vendor_id" data-rule-required="true" readonly>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/purchase/purchase_order/create.blade.php ENDPATH**/ ?>