	...
	<div class="row">
		<div class="col text-right">
			<!-- <ul class="list-inline-item pl-0">
				<?php if($obj_user->hasPermissionTo('pump-operator-create')): ?>
                	<li class="list-inline-item">
	                    <button class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_pump_helper" onclick="form_reset()"><?php echo e(trans('admin.new')); ?> <?php echo e(trans('admin.pump_op')); ?></button>
	                </li>
                <?php endif; ?>
            </ul> -->
		</div>
					...
					<table class="table table-striped table-nowrap custom-table mb-0" id="pumpHelperTable">
						<thead>
							<tr>
								...
								<?php if($obj_user->hasPermissionTo('pump-operator-update')): ?>
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
                <h4 class="modal-title text-center top_title"><?php echo e(trans('admin.add')); ?> <?php echo e(trans('admin.pump_op')); ?></h4>
			...
			<div class="modal-body">
				<div class="row">
			        <div class="col-md-12">
			            <form method="post" action="<?php echo e(Route('pump_op_store')); ?>" id="frmAddPumpHelper" enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	var createUrl = "<?php echo e(Route('pump_op_store')); ?>";
	var updateUrl = "<?php echo e(Route('pump_op_update','')); ?>";
	...
	{
		$('.top_title').html('Edit Pump Operator');
		if(enc_id!='')
		{
			$.ajax({
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/pump_op/index.blade.php ENDPATH**/ ?>