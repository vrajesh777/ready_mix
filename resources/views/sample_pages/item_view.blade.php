								...
								<div class="card-body">
									...
									<div class="photo-gallery mt-4">
									 	<div class="row photos">
								            <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="{{ asset('/') }}images/desk.jpg" data-lightbox="photos"><img class="img-fluid border rounded p-1" src="{{ asset('/') }}images/desk.jpg"></a></div>
								            <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="{{ asset('/') }}images/building.jpg" data-lightbox="photos"><img class="img-fluid border rounded p-1" src="{{ asset('/') }}images/building.jpg"></a></div>
								            <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="{{ asset('/') }}images/loft.jpg" data-lightbox="photos"><img class="img-fluid border rounded p-1" src="{{ asset('/') }}images/loft.jpg"></a></div>
								            <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="{{ asset('/') }}images/building.jpg" data-lightbox="photos"><img class="img-fluid border rounded p-1" src="{{ asset('/') }}images/building.jpg"></a></div>
								            <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="{{ asset('/') }}images/loft.jpg" data-lightbox="photos"><img class="img-fluid border rounded p-1" src="{{ asset('/') }}images/loft.jpg"></a></div>
								            <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="{{ asset('/') }}images/desk.jpg" data-lightbox="photos"><img class="img-fluid border rounded p-1" src="{{ asset('/') }}images/desk.jpg"></a></div>
								        </div>
											...
											<div class="table-responsive">
												<table class="table table-stripped mb-0 datatables">
													...
													<tbody>
														...
														<tr>
															<td><img src="{{ asset('/') }}images/acc-cement.jpg" alt="" width="70"></td>
															<td>BG7813</td>
															<td>acc Cement</td>
														...
														<tr>
															<td><img src="{{ asset('/') }}images/ambuja-cement.jpg" alt="" width="70"></td>
															<td>RB3102</td>
															<td>Ambuja Cement</td>
														...
														<tr>
															<td><img src="{{ asset('/') }}images/ultratech_cement.png" alt="" width="70"></td>
															<td>DE6258</td>
