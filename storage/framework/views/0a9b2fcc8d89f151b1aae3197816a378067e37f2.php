<?php $__env->startSection('main_content'); ?>
	...
	<div class="row align-items-center">
		...
		<div class="col-md-4 justify-content-end d-flex">
			<a href="<?php echo e(Route('loss_adjustment_create')); ?>" class="border-0 btn btn-primary btn-gradient-primary btn-rounde mb-2">Add</a>
								...
								<div class="btn-group">
								 <a href="javascript:void(0)" data-toggle="dropdown" class="action">
								  ...
								  <div class="dropdown-menu dropdown-menu-right">
								    <a href="<?php echo e(Route('loss_adjustment_create')); ?>" class="dropdown-item">View</a>
								    <a href="<?php echo e(Route('loss_adjustment_create')); ?>" class="dropdown-item">Edit</a>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/sample_pages/loss_adjustment.blade.php ENDPATH**/ ?>