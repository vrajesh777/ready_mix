...
<div class="row">
	<form method="POST" action="{{ Route('update_order', base64_encode($arr_order['id'])) }}" id="frmEditBooking">
		...
		<div class="col-sm-12">
			<div class="card">
				<div class="card-body datetimepicker">
					...
					<div class="row">
							...
							<div class="row">
								...
								<div class="form-group col-sm-6">
                                    ...
                                    <div class="position-relative p-0">
                                        <input class="form-control datepicker pr-5" name="delivery_date" id="delivery_date" data-rule-required="true" value="{{ $arr_order['delivery_date'] ?? '' }}" readonly>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="position-relative p-0">
                                        <input class="form-control timepicker pr-5" name="delivery_time" id="delivery_time" data-rule-required="true" placeholder="hh:mm" data-date-format="hh:mm A"  value="{{ date('h:i A',strtotime($arr_order['delivery_time'])) ?? '' }}">
								...
								<div class="form-group col-sm-6">
	            					...
	            					<select class="select2" name="sales_agent">
						...
						<div class="col-sm-6">
							<div class="row">
								...
								<div class="form-group col-sm-6">
									<label class="col-form-label">Pump <span class="text-danger">*</span></label>
		                            <select class="select2" name="pump" data-rule-required="true">
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row clone_master" id="clone_master">
						<div class="form-group col-sm-6">
							<label class="col-form-label">Select Mix <span class="text-danger">*</span></label>
							<select name="prod_id[]" class="prod_id select2" id="productSrch" data-rule-required="true">
								<option>Add Item</option>
								@if(isset($arr_product['contr_details']) && sizeof($arr_product['contr_details'])>0)
									@foreach($arr_product['contr_details'] as $product)
										<option value="{{ $product['product_id'] ?? '' }}" @if($product['product_id'] == $arr_order['ord_details'][0]['product_id']) selected @endif>{{ $product['product_details']['name'] ?? '' }}</option>
									@endforeach
								@endif
							</select>
						...
						<div class="form-group col-sm-6">
							<label class="col-form-label">Cubic Meter ( m³ )<span class="text-danger">*</span></label>
							<input type="number" name="unit_quantity[]" class="form-control" min="1" id="unit_quantity" data-rule-required="true" {{-- onchange="calculate_prop_amnt()" --}} value="{{ $arr_order['ord_details'][0]['quantity'] ?? 0 }}">
						...
						<div style="display:none;">
							<input type="number" name="opc1_rate[]" class="form-control" min="0" id="opc1_rate" onchange="calculate_prop_amnt()" value="{{ $arr_order['ord_details'][0]['opc_1_rate'] ?? 0 }}">
						</div>
						<div style="display:none;">
							<input type="number" name="src5_rate[]" class="form-control" min="0" id="src5_rate" onchange="calculate_prop_amnt()" value="{{ $arr_order['ord_details'][0]['src_5_rate'] ?? 0 }}">
						</div>
						<div style="display:none;">
							<input type="number" name="unit_tax[]" class="form-control unit_tax" min="0" id="unit_tax" value="{{ $arr_order['ord_details'][0]['tax_id'] ?? 0 }}">		
						</div>
					</div>
