	...
	<div class="row">
		<div class="col text-right">
			<!-- <ul class="list-inline-item pl-0">
				@if($obj_user->hasPermissionTo('pump-operator-create'))
                	<li class="list-inline-item">
	                    <button class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_pump_helper" onclick="form_reset()">{{ trans('admin.new') }} {{ trans('admin.pump_op') }}</button>
	                </li>
                @endif
            </ul> -->
		</div>
					...
					<table class="table table-striped table-nowrap custom-table mb-0" id="pumpHelperTable">
						<thead>
							<tr>
								...
								@if($obj_user->hasPermissionTo('pump-operator-update'))
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
                <h4 class="modal-title text-center top_title">{{trans('admin.add')}} {{trans('admin.pump_op')}}</h4>
			...
			<div class="modal-body">
				<div class="row">
			        <div class="col-md-12">
			            <form method="post" action="{{ Route('pump_op_store') }}" id="frmAddPumpHelper" enctype="multipart/form-data">
			            	{{ csrf_field() }}
...
<script type="text/javascript">
	...
	var createUrl = "{{ Route('pump_op_store') }}";
	var updateUrl = "{{ Route('pump_op_update','') }}";
