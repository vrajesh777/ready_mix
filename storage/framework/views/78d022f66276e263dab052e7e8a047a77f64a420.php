	...
	<div class="row">
		<div class="col text-right">
			<ul class="list-inline-item pl-0">
				<?php if($obj_user->hasPermissionTo('purchase-orders-create')): ?>
                <li class="list-inline-item">
                    <a class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" href="<?php echo e(Route('purchase_order_create')); ?>"><?php echo e(trans('admin.new')); ?> <?php echo e(trans('admin.purchase_order')); ?></a>
                </li>
                <?php endif; ?>
            </ul>
		</div>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-striped table-nowrap custom-table mb-0" id="poTable">
						<thead>
							<tr>
								<th><?php echo e(trans('admin.purchase_order')); ?></th>
								<th><?php echo e(trans('admin.total')); ?></th>
								<th><?php echo e(trans('admin.vendor')); ?></th>
								<th><?php echo e(trans('admin.order')); ?> <?php echo e(trans('admin.date')); ?></th>
								<th><?php echo e(trans('admin.payment')); ?> <?php echo e(trans('admin.status')); ?></th>
								...
								<?php $__currentLoopData = $arr_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td>
											...
											<div class="progress">
												<div class="progress-bar bg-success" role="progressbar" style="width: <?php echo e(number_format($per_paid,2) ?? ''); ?>%" aria-valuenow="<?php echo e(number_format($per_paid,2) ?? ''); ?>" aria-valuemin="0" aria-valuemax="100"><?php echo e(number_format($per_paid,2) ?? ''); ?>%</div>
											</div>
										</td>
										<?php if($obj_user->hasPermissionTo('purchase-orders-update')): ?>
										<td>
										...
										<td class="text-center">
											<a class="dropdown-item" href="<?php echo e(Route('purchase_order_view',base64_encode($value['id']))); ?>"><i class="far fa-eye"></i></a>
										</td>
...
<!-- <div class="row">
	<div class="col-md-12">
		<div class="card mt-5">
			<div class="card-body">
				<img class="mx-auto d-block mb-4" src="<?php echo e(asset('/')); ?>images/logo.png" alt="" width="250">
...
<script type="text/javascript">
	$(document).ready(function(){
			...
			buttons: [{
				extend: 'pdf',
				title: '<?php echo e(Config::get('app.project.title')); ?> Purchase Order',
				filename: '<?php echo e(Config::get('app.project.title')); ?> Purchase Order PDF',
				...
				extend: 'excel',
				title: '<?php echo e(Config::get('app.project.title')); ?> Purchase Order',
				filename: '<?php echo e(Config::get('app.project.title')); ?> Purchase Order EXCEL',
				className: 'btn btn-sm btn-primary',
				exportOptions: {
		            columns: ':not(.notexport)',
		        }
				...
				extend: 'csv',
				filename: '<?php echo e(Config::get('app.project.title')); ?> Purchase Order CSV',
				className: 'btn btn-sm btn-primary',
				exportOptions: {
		            columns: ':not(.notexport)',
		        }
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/purchase/purchase_order/index.blade.php ENDPATH**/ ?>