...
<!-- Page Header -->
<div class="row">
	<form method="POST" action="<?php echo e(Route('update_proposal', base64_encode($arr_proposal['id']))); ?>" id="formEditEstimate">
						...
						<div class="col-sm-6 border-right">
							<div class="row">
								...
								<?php if(isset($arr_site_setting['sales_with_workflow']) && $arr_site_setting['sales_with_workflow']!='' && $arr_site_setting['sales_with_workflow'] == '1'): ?>
									<input type="hidden" name="proposal_id" value="<?php echo e($arr_proposal['proposal_id']??''); ?>">
								<?php endif; ?>
								...
								<div class="form-group col-sm-12">
		                            ...
		                            <select name="cust_id" class="select2" id="cust_id" data-rule-required="true">
										...
										<option value="<?php echo e($cust['id'] ?? ''); ?>" <?php echo e($arr_proposal['cust_id']==$cust['id']?'selected':''); ?> ><?php echo e($cust['first_name'] ?? ''); ?> <?php echo e($cust['last_name'] ?? ''); ?></option>
								...
								<div class="form-group col-sm-12">
									<div class="row">
										<div class="col-md-12">
											...
											<?php echo $__env->make('sales.proposals.edit_address_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
										</div>

										<div class="col-md-6">
											<p class="bold"><?php echo e(trans('admin.bill_to')); ?></p>
											<address>
												<span class="billing_street"><?php echo e($arr_proposal['billing_street']??''); ?></span><br>
												<span class="billing_city"><?php echo e($arr_proposal['billing_city']??''); ?></span>,
												<span class="billing_state"><?php echo e($arr_proposal['billing_state']??''); ?></span>
												<br>
												<span class="billing_zip"><?php echo e($arr_proposal['billing_zip']??''); ?></span>
											</address>
										</div>
										<div class="col-md-6">
											<p class="bold"><?php echo e(trans('admin.ship_to')); ?></p>
											<address>
												<span class="shipping_street"><?php echo e($arr_proposal['shipping_street']??''); ?></span><br>
												<span class="shipping_city"><?php echo e($arr_proposal['shipping_city']??''); ?></span>,
												<span class="shipping_state"><?php echo e($arr_proposal['shipping_state']??''); ?></span>
												<br>
												<span class="shipping_zip"><?php echo e($arr_proposal['shipping_zip']??''); ?></span>
											</address>
										</div>
									</div>
								</div>
								<div class="form-group col-sm-6">
									<label class="col-form-label"><?php echo e(trans('admin.proposal')); ?> <?php echo e(trans('admin.date')); ?> <span class="text-danger">*</span></label>
		                            <input type="text" name="date" data-rule-required="true" class="form-control datepicker" value="<?php echo e($arr_proposal['date'] ?? ''); ?>">
								...
								<div class="form-group col-sm-6">
	            					...
	            					<input type="text" class="form-control datepicker" name="expiry_date" value="<?php echo e($arr_proposal['expiry_date']??''); ?>">
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="form-group col-sm-6">
		                            ...
		                            <select class="select" name="status">
										<option value="draft" <?php echo e($arr_proposal['status']=='draft'?'selected':''); ?> ><?php echo e(trans('admin.draft')); ?></option>
										<option value="sent" <?php echo e($arr_proposal['status']=='sent'?'selected':''); ?> ><?php echo e(trans('admin.sent')); ?></option>
										<option value="expired" <?php echo e($arr_proposal['status']=='expired'?'selected':''); ?> ><?php echo e(trans('admin.expired')); ?></option>
										<option value="declined" <?php echo e($arr_proposal['status']=='declined'?'selected':''); ?> ><?php echo e(trans('admin.declined')); ?></option>
										<option value="accepted" <?php echo e($arr_proposal['status']=='accepted'?'selected':''); ?> ><?php echo e(trans('admin.accepted')); ?></option>
									</select>
								</div>
								<div class="form-group col-sm-6">
	            					...
	            					<select class="select" name="assigned_to">
										...
										<option value="<?php echo e($user['id'] ?? ''); ?>" <?php echo e($arr_proposal['assigned_to']==$user['id']?'selected':''); ?> ><?php echo e($user['first_name'] ?? ''); ?> <?php echo e($user['last_name'] ?? ''); ?></option>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
									</select>
								</div>
								<div class="form-group col-sm-12">
		                            ...
		                            <input type="text" class="form-control" name="ref_num" placeholder="<?php echo e(trans('admin.reference')); ?> #" value="<?php echo e($arr_proposal['ref_num']??''); ?>">
		                            <div class="error"><?php echo e($errors->first('ref_num')); ?></div>
								</div>
								<div class="form-group col-sm-12">
									<label class="col-form-label"><?php echo e(trans('admin.admin_note')); ?></label>
		                           	<textarea name="admin_note" rows="5" cols="5" class="form-control" placeholder="<?php echo e(trans('admin.admin_note')); ?>" ><?php echo e($arr_proposal['admin_note']); ?></textarea>
								</div>
					...
					<div class="table-responsive">
						<table class="table" id="tblProds">
							...
							<tbody>
								...
								<?php if(isset($arr_proposal['prop_details']) && sizeof($arr_proposal['prop_details'])>0): ?>
								<?php $__currentLoopData = $arr_proposal['prop_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_key => $product_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php
									...
									<tr>
										<td>
											...
											<textarea name="prod_name[]" cols="5" class="form-control" id="sel_prod_name"><?php echo e($product_value['product_details']['name'] ?? ''); ?></textarea>
										</td>
										<td>
											<textarea name="prod_descr[]" cols="5" class="form-control" id="sel_prod_descr"><?php echo e($product_value['product_details']['description'] ?? ''); ?></textarea>
										</td>
										<td>
											<input type="number" class="form-control" min="0" name="unit_quantity[]" id="unit_quantity" value="<?php echo e($product_value['quantity'] ?? ''); ?>">
										</td>
										<td style="display: none;">
											<input type="number" class="form-control" min="0" name="unit_rate[]" id="unit_rate" readonly="readonly" value="<?php echo e($product_value['rate'] ?? ''); ?>">
										</td>
										<td>
											<input type="number" name="opc1_rate[]" value="<?php echo e($product_value['opc_1_rate']??0); ?>" class="form-control" min="0" id="opc1_rate" data-rule-required="true" onchange="calculate_prop_amnt()" >
										</td>
										<td>
											<input type="number" name="src5_rate[]" value="<?php echo e($product_value['src_5_rate']??0); ?>" class="form-control" min="0" id="src5_rate" onchange="calculate_prop_amnt()" >
										</td>
										<td>
											<select class="select" name="unit_tax[]" id="unit_tax">
												...
												<?php if(isset($arr_taxes) && !empty($arr_taxes)): ?>
												<?php $__currentLoopData = $arr_taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($tax['id']); ?>" <?php if(isset($product_value['product_details']['tax_id']) && $product_value['product_details']['tax_id']!='' && $product_value['product_details']['tax_id'] == $tax['id']): ?> selected <?php endif; ?>><?php echo e($tax['name']); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												<?php endif; ?>
											</select>
										</td>
						              ...
						              <div class="row">
						                 ...
						                 <div class="col-md-4">
						                    <div class="input-group">
						                       <input type="number" class="form-control" min="0" max="100" name="discount_num" id="discount_num" value="<?php echo e($arr_proposal['discount']??''); ?>">
					...
					<div class="row">
						<div class="form-group col-sm-12">
							<label class="col-form-label"><?php echo e(trans('admin.client_note')); ?></label>
		                   	<textarea name="client_note" rows="5" cols="5" class="form-control" placeholder="Client Note" ><?php echo e($arr_proposal['client_note']??''); ?></textarea>
						</div>
						<div class="form-group col-sm-12">
							<label class="col-form-label"><?php echo e(trans('admin.terms_&_conditions')); ?></label>
		                   	<textarea name="terms_n_cond" rows="5" cols="5" class="form-control" placeholder="Terms & Conditions" ><?php echo e($arr_proposal['terms_n_cond'] ?? ''); ?></textarea>
						</div>
					</div>
				...
				<form method="POST" action="<?php echo e(Route('product_store')); ?>" id="createProdForm">
					...
					<div class="row">
				        <div class="form-group col-md-12">
	                        ...
	                        <input type="text" class="form-control" name="name" placeholder="Enter <?php echo e(trans('admin.description')); ?>" data-rule-required="true">
						</div>
						<div class="form-group col-sm-12">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/sales/proposals/edit.blade.php ENDPATH**/ ?>