...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-family:'Arial', sans-serif;">
	...
	<tr>
		...
		<td style="line-height:30px;border-bottom:1px solid #ccc;">&nbsp;&nbsp;<strong style="">Quantity:&nbsp;&nbsp;</strong>{{ $arr_data['order_details']['order']['contract']['quantity'] ?? '' }}</td> 
	</tr>
</table>
...
<table class="table-input" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-family:'Arial', sans-serif;">
	...
	<tr>
		<td class="" style="line-height:30px;border:1px solid #ccc;"><strong style="">&nbsp;&nbsp;Delivery Date:&nbsp;&nbsp;</strong><input type="text" name="delivery_date"  id="delivery_date" class="form-control" value="{{ $arr_data['delivery_date']??'' }}" readonly="" >&nbsp;&nbsp;</td>
		<td style="line-height:30px;border:1px solid #ccc;border-left:none">&nbsp;&nbsp;<strong style="">Slump:</strong><input type="text" name="slump" value="{{ $arr_data['slump']??'' }}"  id="slump" class="form-control" data-rule-number="true" placeholder="Slump" data-rule-required="true">&nbsp;&nbsp;</td> 
		<td style="line-height:30px;border:1px solid #ccc;border-left:none">&nbsp;&nbsp;<strong style="">No Of Cubes Tested:</strong><input type="text" value="{{ $arr_data['no_of_cubes'] }}" name="no_of_cube_tested"  id="no_of_cube_tested" class="form-control" placeholder="No Of Cubes Tested" data-rule-number="true"  data-rule-required="true">&nbsp;&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td style="line-height:30px;border-bottom:1px solid #ccc;border-right:1px solid #ccc;">&nbsp;&nbsp;<strong style="">Method Of Compaction:&nbsp;&nbsp;</strong><input type="text" name="compaction"  id="compaction" class="form-control" placeholder="Method Of Compaction" value="{{ $arr_data['comp_method'] }}" data-rule-maxlength="255" data-rule-required="true"></td> 
	</tr>
	<tr>
		...
		<td style="line-height:30px;border-bottom:1px solid #ccc;border-right:1px solid #ccc;">&nbsp;&nbsp;<strong style="">Air Content:&nbsp;&nbsp;</strong><input type="text" name="air_content"  id="air_content" class="form-control" placeholder="Air Content" value="{{ $arr_data['air_content']??'' }}" data-rule-number="true" data-rule-required="true"></td> 
		<td style="line-height:30px;border-bottom:1px solid #ccc;border-right:1px solid #ccc;">&nbsp;&nbsp;<strong style="">Sampled By:&nbsp;&nbsp;</strong><input type="text" name="sampled_by"  id="sampled_by" class="form-control" data-rule-maxlength="255" value="{{ $arr_data['sampled_by'] }}" placeholder="Sampled By" data-rule-required="true"></td> 
	</tr>
</table>
<br>
...
<table class="table-input s-input" width="100%" border="0" cellpadding="0" cellspacing="0" style="border:none;font-size:14px; font-family:'Arial', sans-serif;" id="strength_table">
		  ...
		  <tr>
		      ...
		      <th style="background-color:#323a45;color:#fff;line-height:18px;height:22px;font-size:13px;border-right:1px solid #ccc;" class="no-print">Action</th>
		  </tr>
		  ...
		  <input type="hidden" name="index_no" id="index_no" value="{{ $index_no }}">
	        ...
	        <td class="no-print" style="padding:0 5px;line-height:30px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc;"><a class="add-strength"><i class="fas fa-plus"></i>Add</a></td>
	  	  </tr>
</table>
</div>
<table>
...
$(document).ready(function () 
{
   ...
   var index_no = parseInt($('#index_no').val())+1;
    $(".add-strength").click(function()
    {
        ...
        html+='<td style="line-height:30px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc;"><a class="remove-strength">Remove</a></td></tr>';
