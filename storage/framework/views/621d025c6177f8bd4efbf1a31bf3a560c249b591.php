		...
		<div class="modal right fade settings" id="settings"  role="dialog" aria-modal="true">
			<div class="toggle-close">
      			<div class="toggle" data-toggle="modal" data-target="#settings"><i class="fal fa-cog fa-w-16 fa-spin fa-2x"></i>
      			</div>
    		</div>
        ...
        <div class="sidebar-contact">
          	<div class="toggle" data-toggle="modal" data-target="#settings"><i class="fal fa-cog fa-w-16 fa-spin fa-2x"></i></div>           
        </div>
		...
		<!-- theme JS -->
		<script src="<?php echo e(asset('')); ?>js/theme-settings.js"></script>
		...
		<script src="<?php echo e(asset('/js/sweetalert_msg.js')); ?>"></script>
		<script src="<?php echo e(asset('/js/MultiImageUploading.js')); ?>"></script>
		<script src="<?php echo e(asset('/js/ajax_loader.js')); ?>"></script>

		<script type="text/javascript" src="<?php echo e(asset('/js/datatables/dataTables.buttons.min.js')); ?>" ></script>
		<script type="text/javascript" src="<?php echo e(asset('/js/datatables/jszip.min.js')); ?>" ></script>
		<script type="text/javascript" src="<?php echo e(asset('/js/datatables/pdfmake.min.js')); ?>" ></script>
		<script type="text/javascript" src="<?php echo e(asset('/js/datatables/vfs_fonts.js')); ?>" ></script>
		<script type="text/javascript" src="<?php echo e(asset('/js/datatables/buttons.html5.min.js')); ?>" ></script>
		<!-- Custom JS -->
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$('body').on('click','.btn-attend', function() {
					var attend_mode = $(this).val();
					$.ajax({
						url: "<?php echo e(Route('user-attend','')); ?>/"+attend_mode,
		  				type:'POST',
		  				data : {
		  				...
		  				success:function(response)
		  				{
		  					...
		  					if(response.status == 'success') {
		  						$("#attend_div").load(location.href + " #attend_div");
		  						if( typeof  response.data !== 'undefined' ) {
		  							countUpFromTime(response.data.date_time, 'countup1');
		  						}
		  						if(attend_mode == 'check_out') {
		  							$('.currTime').remove();
		  						}
						    }
			...
			var date_time = '<?php echo e($arr_login_user['date_time'] ?? ''); ?>';
			window.onload = function() {
				// Month Day, Year Hour:Minute:Second, id-of-element-container
				if(date_time!='')
				{
					countUpFromTime(date_time, 'countup1'); // ****** Change this line!
				}
			};
			...
			function countUpFromTime(countFrom, id) {
				...
				var inputTime = ("0" + hours).substr(-2) + ":" + ("0" + mins).substr(-2) + ":" + ("0" + secs).substr(-2) + ' Hrs';
				$('.currTime').html(inputTime);
...
</html><?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/layout/_footer.blade.php ENDPATH**/ ?>