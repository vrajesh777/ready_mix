...
<tr class="">
	...
	<td style="display: none;">
		<input type="number" name="unit_rate[]" value="{{ $rate??0 }}" class="form-control" min="{{ $arr_product['min_quant'] ?? '1' }}" readonly="readonly" data-rule-required="true">
	</td>
	<td style="display: none;">
	...
	<td class="unit_price" style="display: none;">{{ format_price($total) }}</td>
	<td>
