...
<table class="table-input" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-family:'Arial', sans-serif;">
	<tr><td colspan="3" style=""><strong style="line-height:30px">{{ trans('admin.slump') }}:</strong></td> </tr>
	<tr>
		<td class="" style="line-height:30px;border:1px solid #ccc;"><strong style="">&nbsp;&nbsp;{{ trans('admin.pouring_date') }}:&nbsp;&nbsp;</strong><input type="text" name="delivery_date"  id="delivery_date" class="form-control" value="{{ $arr_data['delivery_date']??'' }}" readonly="" >&nbsp;&nbsp;</td>
		<td style="line-height:30px;border:1px solid #ccc;border-left:none">&nbsp;&nbsp;<strong style="">{{ trans('admin.slump') }}:</strong><input type="text" name="slump" value="{{ $arr_data['cylinder_slump']??'' }}"  id="slump" class="form-control" data-rule-number="true" placeholder="Slump" data-rule-required="true">&nbsp;&nbsp;</td> 
		<td style="line-height:30px;border:1px solid #ccc;border-left:none">&nbsp;&nbsp;<strong style="">{{ trans('admin.no_of_cylinder_tested') }}:</strong><input type="text" value="{{ $arr_data['cylinder_no_of_cubes'] }}" name="no_of_cube_tested"  id="no_of_cube_tested" onchange="addCube(this.value)" class="form-control" placeholder="No Of Cubes Tested" data-rule-number="true"  data-rule-required="true">&nbsp;&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td style="line-height:30px;border-bottom:1px solid #ccc;border-right:1px solid #ccc;">&nbsp;&nbsp;<strong style="">{{ trans('admin.air_content') }}:&nbsp;&nbsp;</strong><input type="text" name="air_content"  id="air_content" class="form-control" placeholder="Air Content" value="{{ $arr_data['cylinder_air_content']??'' }}" data-rule-number="true" data-rule-required="true"></td> 
   ...
   $('.datepicker').datepicker({
	...
	var currentDateTested   = $(this).val(); 
	 ...
	 $("#strength_table").on('change','.mload',function(){
	 	...
	 	var cstrength_kg = mload/1.732966;
	 	var c_strength   = parseFloat(mload*1000/area);
...
function addCube(no_of_cubes)
{
	...
	var exist_no_of_cubes = "{{ $arr_data['cylinder_no_of_cubes'] }}";
	...
	if(no_of_cubes>0)
	{
        ...
        html+='<td style="line-height:30px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;">&nbsp;&nbsp;<input type="text" name="sarea['+i+']"  id="sarea_'+i+'" class="form-control area" value="17671" readonly="" placeholder="S/Area" data-rule-required="true" data-rule-number="true"></td>';
        html+='<td style="line-height:30px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;">&nbsp;&nbsp;<input type="text" name="height['+i+']"  id="height_'+i+'" class="form-control height" value="300" readonly="" placeholder="Height" data-rule-required="true" data-rule-number="true"></td>';
      ...
      for(j=1;j<=parseInt(half_rows);j++)
	  {
        ...
        html+='<td style="line-height:30px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;">&nbsp;&nbsp;<input type="text" name="sarea['+k+']"  id="sarea_'+k+'" class="form-control area" value="17671" readonly="" placeholder="S/Area" data-rule-required="true" data-rule-number="true"></td>';
        html+='<td style="line-height:30px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;">&nbsp;&nbsp;<input type="text" name="height['+k+']"  id="height_'+k+'" class="form-control height" value="300" readonly="" placeholder="Height" data-rule-required="true" data-rule-number="true"></td>';
