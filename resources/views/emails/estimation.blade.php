                    ...
                    <tr>
                        <td bgcolor="#FFFFFF" style="border:1px solid #e5e5e5;">
                            <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr><td style="color: #333333;font-size: 15px;padding-top: 3px;text-align: center;">Business Proposal</td></tr>
                                <tr>
                                    <td height="40"></td>
                                </tr>
                                <tr>
                                    <td style="color: #333333; font-size: 16px; padding: 0 30px;">
                                        Dear <span style="color:#8f4799;font-family: 'Latomedium',sans-serif;">{{ $username ?? '' }},</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color: #545454;font-size: 15px;padding: 12px 30px;">
                                        <p>Please find our attached proposal.</p>
                                        <p>This proposal is valid until: {proposal_open_till}<br> You can view the proposal on the following link:<br>
                                            <a href="{{ $prop_page_link??'' }}">{{ $prop_page_link??'' }}</a>
                                        </p>
                                        <p>Please don't hesitate to comment online if you have any questions.</p>
