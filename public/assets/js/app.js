$(document).ready(function() {
    ...
    // For select All. Just Put <option value="">All</option>
    ...
    $(document).on('click', '.mail-important', function() {
        $(this).find('i.fa').toggleClass('fa-star').toggleClass('fa-star ');
    });
...
function common_ajax_store_action(response, reload=true) {
    if(response.status == 'error') {
        if(typeof response.validation_err != 'undefined') {
            $.each(response.validation_err, function (key, val) {
