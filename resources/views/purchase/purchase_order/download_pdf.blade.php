...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:10px; font-family:'Arial', sans-serif;border:none">
		<tr>
			<td colspan="2" style="line-height:20px;border:1px solid #555;"><strong style="">&nbsp;&nbsp;To:&nbsp;&nbsp;</strong>{{ $arr_po['user_meta'][0]['meta_value'] ?? '' }}</td>
			<td style="line-height:20px;border:1px solid #555;border-bottom:1px solid #555;">&nbsp;&nbsp;<strong style="">P.O No.:</strong>&nbsp;&nbsp;{{ $arr_po['order_number'] ?? '' }}</td> 
		</tr>
		<tr>
			...
			<td style="line-height:20px;border-bottom:1px solid #555;border-right:1px solid #555;">&nbsp;&nbsp;<strong style="">Date:&nbsp;&nbsp;</strong>{{ $arr_po['order_date'] ?? '' }}</td> 
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:none;font-size:10px; font-family:'Arial', sans-serif;">
		...
		@if(isset($arr_po['purchase_order_details']) && sizeof($arr_po['purchase_order_details'])>0)
			@foreach($arr_po['purchase_order_details'] as $key => $order)
				<tr>
					<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;{{ $key+1 }}</td>
					<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;{{ $order['item_detail']['commodity_code'] ?? '' }}</td>
					<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;{{ $order['item_detail']['description'] ?? '' }}</td>
					<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;{{ $order['quantity'] ?? '' }}</td>
					<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;{{ $order['unit_price'] ?? '' }}</td>
					<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;border-right:1px solid #555;">&nbsp;&nbsp;{{ number_format($order['total'],2) ?? '' }}</td>
				</tr>
			@endforeach
		@endif
		...
		<tr>
			...
			<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;border-right:1px solid #555;">&nbsp;&nbsp;{{ number_format($arr_po['sub_total'],2) ?? 0 }}</td>
		</tr>
		<tr>
			<td colspan="4" style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;</td>
			...
			<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;border-right:1px solid #555;">&nbsp;&nbsp;{{ number_format($arr_po['dc_total'],2) ?? 0 }}</td>
		</tr>
		<tr>
			<td colspan="2" style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;<strong>Total Amount</strong></td>
			<td colspan="2" style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;">&nbsp;&nbsp;{!! $amount_in_worrd ?? '' !!}</td>
			<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;text-align:right;">&nbsp;&nbsp;<strong>Total</strong>&nbsp;&nbsp;</td>
			<td style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;border-right:1px solid #555;">&nbsp;&nbsp;{{ number_format($arr_po['total'],2) ?? 0 }}</td>
		</tr>
		...
		<tr>
			...
			<td colspan="1" style="line-height:20px;border-bottom:1px solid #555;border-left:1px solid #555;border-right:1px solid #555;">&nbsp;&nbsp;{{ $arr_po['delivery_Date'] ?? '' }}</td>
		</tr>
		<tr>
			<td colspan="6" style="line-height:15px;border-left:1px solid #555;border-right:1px solid #555;border-bottom:1px solid #555;">&nbsp;</td>
		</tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:none;font-size:10px; font-family:'Arial', sans-serif;">
		...
		<tr>
			...
			<td colspan="2" style="text-align:right;">&nbsp;&nbsp;<img src="{{ asset('/') }}images/footer-logo.png" alt="" width="200">&nbsp;&nbsp;</td>
		</tr>
		<tr>
