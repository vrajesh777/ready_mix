...
<div class="row">
	...
	<div class="col-sm-12">
		...
		<div class="row align-items-center">
			...
			<div class="col-md-4">
				{{-- <a href="{{ Route('dowload_invoice', base64_encode($arr_order['id'])) }}" class="border-0 btn btn-primary btn-gradient-primary btn-rounded mb-2" download="">Download</a> --}}
		               	...
		               	<table class="table">
		               		...
		               		<tbody>
		               			...
		               			<?php
		               				...
		               				$tot_before_tax = $row['rate']??0*$row['quantity'];

		               				$net_tot += $tot_before_tax;

		               				$tax_amnt = round($tax_det['tax_rate']??0 * ($tot_before_tax / 100),2);
		               				$tot_tax += $tax_amnt;
