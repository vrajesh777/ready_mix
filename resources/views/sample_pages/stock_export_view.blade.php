...
@section('main_content')
	...
	<div class="row align-items-center">
		<h4 class="col-md-8 card-title mt-0 mb-2">Stock export info</h4>
	</div>

	<div class="card">
		<div class="card-body">
			<div class="profile-box flex-fill"></div>
				<h3 class="card-title border-bottom pb-2 mt-0 mb-3">Export Ouput Slip
					<a href="{{ Route('stock_export_create') }}" class="edit-icon"><i class="fa fa-pencil"></i></a>
				</h3>
				<div class="row">
					<div class="col-md-3 offset-7 mb-2">Days 30 Month 01 Year 2021</div>
					<div class="col-md-2 mb-2">Debit: .....................</div>
					<div class="col-md-3 offset-7 mb-2">Voucher number: XK01</div>
				...
				<div class="row">
					<div class="col-md-4">		
						<ul class="personal-info border rounded-sm mt-2">
							...
							<li>
								...
								<div class="text">Studio 103. The Business Centre 61 Wellfield Road Roath Cardiff CF24 3DG.</div>
							</li>
						...
						<div class="table-responsive">
							<table class="table table-stripped mb-0">
								...
								<tbody>
									<tr>
										<td>NK01</td>
										<td>we denounce with righteous</td>
										<td>2523</td>
										<td>Warehouse-1</td>
										<td>Kilograms</td>
										<td>5.00</td>
                    ...
                    <td>500.00</td>
								...
								<tr>
								<td colspan="2" class="border-0 text-center">Receiver<br>(Sign, full name)</td>	
	...
	<div class="card mb-0">
		<div class="card-body">
			<h3 class="card-title border-bottom pb-2 mt-0 mb-3"><i class="fal fa-hand-holding-box text-black-50 mr-1"></i>Stock export detail</h3>
            <div id="small-table">
