...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:10px; font-family:'Arial', sans-serif;text-align:center;">
		...
		<tr><td colspan="3" style="line-height:15px;text-align:left;"><?php echo e(trans('admin.date')); ?>: <?php echo e($arr_proposal['date'] ?? ''); ?></td></tr>
		<tr>
			...
			<td style="width:45%">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-bottom:4px;font-size:10px; font-family:'Arial', sans-serif;">
					...
					<tr><td style="line-height:16px"><strong style="">
						<?php echo e($arr_proposal['to']??''); ?>&nbsp;<?php echo e($cust_company??''); ?>

					</strong></td></tr>
					<tr><td style="line-height:16px"><strong style=""><?php echo e(trans('admin.ref')); ?>:</strong><?php echo e($arr_proposal['ref_num']??''); ?></td></tr>
					<tr><td style="line-height:16px"><strong style=""><?php echo e(trans('admin.project')); ?>:</strong>N/A</td></tr>
				</table>
			</td>
		</tr>
	...
	<table class="table" width="100%" border="0" cellpadding="0" cellspacing="0" style="border:none;font-size:9px; font-family:'Arial', sans-serif;text-align: center;">
		...
		<?php if(isset($arr_proposal['prop_details']) && !empty($arr_proposal['prop_details'])): ?>
		<?php $__currentLoopData = $arr_proposal['prop_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<?php
			...
			?>
			<tr>
				<td style="line-height:22px;border:1px solid #ccc;border-top:none;"><?php echo e(++$key); ?></td>
				<td style="line-height:22px;border:1px solid #ccc;border-top:none;">
					<?php echo e($prod_det['name'] ?? ''); ?>

				</td>
				<td style="line-height:22px;border:1px solid #ccc;border-top:none;"><?php echo e(format_price($row['opc_1_rate']??0)); ?></td>
				<td style="line-height:22px;border:1px solid #ccc;border-top:none;"><?php echo e(format_price($row['src_5_rate']??0)); ?></td>
			</tr>
...
<?php /**PATH /home/cintvase/readymix.seeen.sa/resources/views/sales/proposals/download_pdf_new.blade.php ENDPATH**/ ?>